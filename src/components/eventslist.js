            ...
            <Grid>
               ...
               <tbody> <tr>
                ...
                {open1 ?
                 ...
                 <Form  style={{ padding:'20px 100px 20px 100px', border:'2px solid blue'}} class={"navbar-form navbar left"} >
                    <div>
                    ...
                    <div>
                        ...
                        <input required={true} style={{textAlign:'center'}} class= {"form-control"} type="time" name="time" min="08:40" max="23:59" 
                        onChange={( {target:{value}}) => {
                            // console.log('===>', value)
                    ...
                    <div>
                        ...
                        <input required={true} style={{textAlign:'center'}} class= {"form-control"} type="number" min="1" max="50" name="people" 
                        onChange={( {target:{value}}) => {
                            // console.log('===>', value)
                    ...
                    <br />
                    <Button bsStyle={"primary"} type="button" onClick={this.onSubmit}>Submit</Button>
                    <br />
                </Form>
             </Modal> : null
                }
